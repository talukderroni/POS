...
namespace POSApplication.Controllers
{
    public class ExpenseTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ExpenseType1,PayOver")] ExpenseType expenseType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ExpenseType1,PayOver")] ExpenseType expenseType)
        {
            if (ModelState.IsValid)
            {
